    ...
    public class ShadowsMidtonesHighlightsEditor : BaseEffectEditor
    {
        ...
        class ColorWheel
        {
            ...
            internal Color DoGUI(Color color, int diameter)
            {
                ...
                {
                    // Title
                    using (new EditorGUILayout.HorizontalScope(GUILayout.Width(m_Diameter - 1)))
                    {
                    ...
                    // Hue wheel
                    using (new EditorGUILayout.HorizontalScope(GUILayout.Width(m_Diameter)))
                    {
            ...
            void UpdateHueWheel(bool sizeChanged)
            {
                ...
                var pixels = m_WheelTexture.GetPixels();
            ...
            Texture2D MakeTexture(int width, int height)
            {
                var tex = new Texture2D(width, height, TextureFormat.ARGB32, false, false)
                {
                    ...
                    alphaIsTransparency = true // Used for cheap AA
                };
                return tex;
            }
