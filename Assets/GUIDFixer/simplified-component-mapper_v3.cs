...
public class SimplifiedComponentMapper : EditorWindow
{
    private const int MAX_CONSOLE_LINES = 405;
    private Rect dropArea;
    
    [MenuItem("Window/Simplified Component Mapper")]
    public static void ShowWindow()
    {
        GetWindow<SimplifiedComponentMapper>("Simplified Component Mapper");
    }
